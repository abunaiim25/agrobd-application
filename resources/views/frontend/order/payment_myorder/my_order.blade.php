...
@section('frontend_content')
                        ...
                        <div class="card " style="overflow: auto">
                            ...
                            <div class="table-wrapper p-4" style="overflow: auto">
                                ...
                                <ul class="nav nav-pills mb-3">
                                    <li class="nav-item ">
                                        <a class="nav-link " style="color: #81B622"  aria-current="page" href="{{ url('my_orders') }}">Hand Cash</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link active" style="background-color: #81B622" href="{{ url('my_order_payment') }}">Payment Online</a>
                                    </li>
                                </ul>
    ...
    <section id="banner" class="my-5 pt-5 container p-5"
        ...
        <div class="container">
            ...
            <a  class="btn text-uppercase  button-style" href="{{ url('shop') }}" role="button">AgroBd Shop</a>
        </div>
    </section>
