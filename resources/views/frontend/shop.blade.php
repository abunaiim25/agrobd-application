...
@section('frontend_content')
    <section class=" container featured my-5 pb-5 pt-3">
        ...
        <div class="mt-5">
            ...
            <div class="py-5">
                <h2 class="shop-section-title"><strong>আমাদের বৈশিষ্ট্যযুক্ত পণ্য</strong></h2>
                <p class="shop-section-subtitle">বাংলাদেশের কৃষকদের দ্বারা উৎপাদিত সর্বোত্তম মানের পণ্য, সাশ্রয়ী মূল্যে AgroBd-এ পাবেন</p>
            </div>
